...
<div class="row justify-content-center">
    ...
    <div class="col-8">
        ...
        <div class="card card-outline card-primary animated fadeIn shadow-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="21%">
                                    ...
                                    <form action="{{ route('item.destroy', $inmueble->id) }}" method="POST"
                                        onsubmit="return confirm('Esta seguro que desea borrar el inmueble {{$inmueble->nombre}}?');"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td width="21%">
                                    ...
                                    <form action="{{ route('item.destroy', $mueble->id) }}" method="POST"
                                        onsubmit="return confirm('Esta seguro que desea borrar el item {{$mueble->nombre}}?');"
                                        style="display: inline-block;">
                                        <input type="hidden" name="_method" value="DELETE">
                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                                        <input type="submit" class="btn btn-xs btn-danger" value="Borrar">
